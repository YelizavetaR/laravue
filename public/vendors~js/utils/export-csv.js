(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["vendors~js/utils/export-csv"],{
...
function exportFromJSON(_a) {
    ...
    switch (exportType) {
        case 'txt': {
            return processor(JSONData, exportType, Object(_utils__WEBPACK_IMPORTED_MODULE_0__["normalizeFileName"])(fileName, 'txt', fileNameFormatter));
        }
        case 'json': {
            return processor(JSONData, exportType, Object(_utils__WEBPACK_IMPORTED_MODULE_0__["normalizeFileName"])(fileName, 'json', fileNameFormatter));
        }
        case 'csv': {
            ...
            return processor(content, exportType, Object(_utils__WEBPACK_IMPORTED_MODULE_0__["normalizeFileName"])(fileName, 'csv', fileNameFormatter));
        }
        case 'xls': {
            Object(_utils__WEBPACK_IMPORTED_MODULE_0__["assert"])(Object(_utils__WEBPACK_IMPORTED_MODULE_0__["isArray"])(safeData), MESSAGE_IS_ARRAY_FAIL);
            var content = Object(_converters__WEBPACK_IMPORTED_MODULE_2__["createXLSData"])(safeData, beforeTableEncode);
            return processor(content, exportType, Object(_utils__WEBPACK_IMPORTED_MODULE_0__["normalizeFileName"])(fileName, 'xls', fileNameFormatter));
        }
        case 'xml': {
            var content = Object(_converters__WEBPACK_IMPORTED_MODULE_2__["createXMLData"])(safeData);
            return processor(content, exportType, Object(_utils__WEBPACK_IMPORTED_MODULE_0__["normalizeFileName"])(fileName, 'xml', fileNameFormatter));
        }
        default:
...
//# sourceMappingURL=export-csv.js.map?id=c070bf3ca3616f43383a